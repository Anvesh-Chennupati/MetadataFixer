...
from mutagen.id3 import ID3, TORY, TYER, TPUB, APIC, USLT, COMM,ID3NoHeaderError
...
def writeSongMeta(filename= None, raw_song = None, Meta_data = None):
    if raw_song == None and Meta_data == None:
        print('Error')
    else:
        embed(filename,Meta_data)
